...
class AppTheme:
    ...
    def tokens(self) -> dict[str, str]:
        ...
        return {
            ...
            "success_bg": "#D1FAE5" if self.mode == "light" else "rgba(52, 211, 153, 0.16)",
            "danger": self.negative,
            "danger_bg": "#FEE2E2" if self.mode == "light" else "rgba(248, 113, 113, 0.14)",
            "warning": self.warning,
            "warning_bg": "rgba(245, 158, 11, 0.15)" if self.mode == "dark" else "#FEF3C7",
            "info": self.primary,
            "info_bg": self.primary_soft if self.mode == "dark" else "#DBEAFE",

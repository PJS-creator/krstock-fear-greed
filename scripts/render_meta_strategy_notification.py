...
from portfolio.meta_strategy_notification import (  # noqa: E402
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Render the daily meta-strategy GitHub notification.")
    ...
    content = render_meta_strategy_notification(
        latest_run=latest_run,
        signal=signal,
